...
echo '3500000' > /sys/class/power_supply/usb/current_max
echo '3500000' > /sys/class/power_supply/usb/hw_current_max
...
echo '3500000' > /sys/class/power_supply/main/current_max
echo '3500000' > /sys/class/power_supply/main/constant_charge_current_max
echo '3500000' > /sys/class/power_supply/battery/current_max
...
echo '3500000' > /sys/class/power_supply/pc_port/current_max
echo '3500000' > /sys/class/power_supply/constant_charge_current__max
sleep 1
done